...
# Make sure you have set APIFY_TOKEN in Vercel Settings -> Environment Variables
...
async def get_rank(keyword: str):
    try:
        ...
        if not results:
            return {"keyword": keyword, "rank": "No results found"}
        ...
        return {"keyword": keyword, "rank": f"Error: {str(e)}"}
